                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="noticias" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                             ...
                             <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#permisos" aria-expanded="false" aria-controls="permisos">
                                <div class="sb-nav-link-icon"><i class="fas fa-book-open"></i></div>
                               Permisos
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="permisos" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="<?php echo e(route('crear.permisos')); ?>">Agregar Permisos</a>
                                    <a class="nav-link" href="<?php echo e(route('listar.permisos')); ?>">Listar Permisos</a>
                                </nav>
                            </div>
